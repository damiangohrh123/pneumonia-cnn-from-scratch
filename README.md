...
| **v2.0** | 1-Conv (8 fil) | L2 Reg & Shuffling | 91.07% | 79.49% | 3.4004 |
| **v3.0** | 1-Conv (8 fil) | High L2 (0.005) | 92.06% | 67.79% | 1.1001 |
| **v4.0** | 1-Conv (16 fil) | Double Filter Capacity | 91.56% | 83.65% | 6.1741 |
| **v5.0** | 2-Conv (Deep) | Huber Loss & 0.0025 LR | 97.87% | 80.45% | 0.0785 |
| **v6.0** | 2-Conv (Deep) | Augmentation & Weights | 92.73% | **86.22%** | 0.1241 |

<p align="center"><strong>Table 1.</strong> Iterative Model Development and Performance Metrics</p>
</div>
